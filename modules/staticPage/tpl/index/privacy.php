<?php
$tpl->title="Privacy Policy.";
$tpl->desc="Privacy Policy. Description what of data the website collects and how the website is using them.";
?>
<article class="hero clearfix">
	<div class="col_100 terms">
		<h3><a name="privacy">Privacy Policy</a></h3>
		<span>1. We collect</span>
		<p>Our servers are designed to automatically record information about your activity on our website which also includes all the information sent by your browser time to time. This information includes differnet things such as your IP address, name of type of the browser you are using and also the webpage you were visiting before you came to <?=HREF?>. It also includes the data about your Windows and the language you are using.</p>
		<span>2. Cookies</span>
		<p>Cookies are used to store your personal information while you are on the site and this also incresaes the security.<br />
This doesn't take much of your time as only one pop-up launches every time you come to the website.<br /><br />
Some third party advertisements are also used to support our website <?=HREF?> financially. <br />
