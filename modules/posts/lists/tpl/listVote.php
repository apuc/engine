...
<script type="text/javascript">
	function like(id,isLike){
		$.post(document.location.basepath+'/?module=posts/admin&act=updateLike',{pid:id,isLike:isLike});
	}
			...
			<?if(!empty($data->posts)){
				...
				<div>
					...
					<div class="like">
						...
						<?if($p->canVote){?>
						<a href="javascript:void(0);" class="a_like" onclick="like(<?=$p->id?>,1);$(this).parent().parent().fadeOut(500);" title="Like"></a>
						<a href="javascript:void(0);" class="a_dislike" onclick="like(<?=$p->id?>,0);$(this).parent().parent().fadeOut(500);" title="Dislike"></a>
						<?}?>
					</div>
					<div class="clear"></div>
				</div>
